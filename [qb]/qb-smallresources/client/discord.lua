local appid = '00000000000000000' 
local image1 = 'yourlogo'
local image2 = 'yourlogo'
local prevtime = GetGameTimer()
local prevframes = GetFrameCount()
local fps = -1
local disocrd = 'fivem://connect/127.0.0.1:30120'
local fivem = "fivem://connect/127.0.0.1:30120"
