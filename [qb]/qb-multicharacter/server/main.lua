...
Citizen.CreateThread(function()
    if (GetCurrentResourceName() ~= "qb-multicharacter") then 
        print("[" .. GetCurrentResourceName() .. "] " .. "IMPORTANT: This resource must be named qb-multicharacter for it to work properly!");
        print("[" .. GetCurrentResourceName() .. "] " .. "IMPORTANT: This resource must be named qb-multicharacter for it to work properly!");
        print("[" .. GetCurrentResourceName() .. "] " .. "IMPORTANT: This resource must be named qb-multicharacter for it to work properly!");
        print("[" .. GetCurrentResourceName() .. "] " .. "IMPORTANT: This resource must be named qb-multicharacter for it to work properly!");
    end
