            ...
            Citizen.CreateThread(function()
                while true do
                    ...
                    for k, v in pairs(Config.ATMModels) do
                        ...
                        if distance < 1.5 then
                            ...
                            if not isTextUiOpen and Config.CodemTextUi.atmtextui then
                                exports["meteo-textui"]:OpenTextUI(Config.CodemTextUi.atmText, Config.CodemTextUi.atmKey, Config.CodemTextUi.atmThema)
                                isTextUiOpen = true
                    ...
                    if isTextUiOpen and not isInZone and Config.CodemTextUi.atmtextui then
                        exports["meteo-textui"]:CloseTextUI()
                        isTextUiOpen = false
                    end
                    ...
                    for l, s in pairs(Config.BankLocations) do
                        ...
                        if distance2 < 1.5 then
                            ...
                            if not isTextUiOpenBank and Config.CodemTextUi.banktextui then
                                exports["meteo-textui"]:OpenTextUI(Config.CodemTextUi.bankText, Config.CodemTextUi.bankKey, Config.CodemTextUi.bankThema)
