...
Config.Locations = {
    Pillbox = {
        ...
        clockInAndOut = {
            ...
            coords = vec3(314.31, -568.59, 43.27), -- Location of where to go on and off duty(If not using target)
            ...
            target = {
                ...
                coords = vec3(314.31, -568.59, 43.27),
                heading = 337.07,
                width = 2.0,
                length = 1.0,
                minZ = 43.02 - 0.9,
        ...
        PersonalLocker = {
            ...
            coords = vec(306.69, -569.14, 43.27),   -- Location of where to access personal locker (If target is disabled)
            ...
            target = {
                enabled = false,                    -- If enabled, the location and distance above will be obsolete
                label = 'Access Locker',
                coords = vector3(306.69, -569.14, 43.27),
                heading = 252.09,
                width = 2.0,
                length = 1.0,
                minZ = 43.02 - 0.9,
        ...
        BossMenu = {
            ...
            Coords = vec3(310.5, -568.53, 43.27), -- Location of boss menu (If not using target)
            ...
            Target = {
                ...
                coords = vec3(310.5, -568.53, 43.27),
                heading = 185.11,
                width = 2.0,
                length = 1.0,
                minZ = 43.02 - 0.9,
        ...
        CheckIn = {                                      -- Hospital check-in
            ...
            Ped = 's_m_m_scientist_01',                  -- Check in ped
            Coords = vec3(302.04, -591.13, 43.27- 0.9), -- Coords of ped
            Distance = 4.85,                             -- Distance to show textUI (If target is not enabled below)
            ...
            Target = {
                enabled = false,                          -- Enable Target? (Can be customized in wasabi_bridge/customize/cl_customize.lua the target system)
                label = 'Check In',
                coords = vec3(302.04, -591.13, 43.27),
                heading = 339.94,
                distance = 5.0,
                width = 2.0,
                length = 1.0,
        ...
        MedicalSupplies = {                                                     -- EMS Shop for supplies
            ...
            Coords = vec3(326.24, -584.44, 43.27 - 0.95),                       -- Coords of ped/target
            Heading = 156.87,                                                   -- Heading of ped
            Supplies = {                                                        -- Supplies
