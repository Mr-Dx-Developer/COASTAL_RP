...
Config.empresas = {
	-- ["galaxy"] = {
		...
		-- ['logo'] = "https://cdn.discordapp.com/attachments/533398980428693550/776882252142739456/Sem_titulo.png?ex=65eb5e7a&is=65d8e97a&hm=f8697308970e0d1f0ef43f59678d4018a5adf38e36b9f9daaed2f41ab33cb1b5&", -- Company image (must be in square format. Ideal size: 555x555)
	...
	["split_sides"] = {
		...
		['logo'] = "images/locations/split_sides.png",
	...
	["motoclube_1"] = {
		...
		['logo'] = "images/locations/motoclube_1.png",
	...
	["motoclube_2"] = {
		...
		['logo'] = "images/locations/motoclube_2.png",
	...
	["arcadius"] = {
		...
		['logo'] = "images/locations/arcadius.png",
	...
	["maze_bank_1"] = {
		['nome'] = "Maze Bank",
		['logo'] = "images/locations/maze_bank_1.png",
	...
	["maze_bank_2"] = {
		...
		['logo'] = "images/locations/maze_bank_2.png",
	...
	["lom_bank"] = {
		['nome'] = "Lom Bank",
		['logo'] = "images/locations/lom_bank.png",
	...
	["escritorio_1"] = {
		...
		['logo'] = "images/locations/escritorio_1.png",
	...
	["escritorio_2"] = {
		...
		['logo'] = "images/locations/escritorio_2.png",
	...
	["escritorio_3"] = {
		...
		['logo'] = "images/locations/escritorio_3.png",
	...
	["clubhouse_2"] = {
		...
		['logo'] = "images/locations/clubhouse_2.png",
...
Config.blips = {
	-- { 397.06420898438,-712.62371826172,29.073789596558,475,4,"Business",0.5 }, 	-- Boate Galaxy
	{ -430.09323120117,261.73965454102,83.004585266113,475,4,"Business",0.5 }, 	-- Split Sides West
	{ 977.77209472656,-94.102691650391,74.868125915527,475,4,"Business",0.5 }, 	-- Moto Clube Primario
	{ 987.27813720703,-144.57054138184,74.271415710449,475,4,"Business",0.5 },	-- Moto Clube Secundário
	{ -116.4582901001,-604.75909423828,36.276329040527,475,4,"Business",0.5 }, 	-- Arcadius Center
	{ -70.92317199707,-801.04693603516,44.222755432129,475,4,"Business",0.5 }, 	-- Maze bank
	{ -1371.0145263672,-503.27758789062,33.153045654297,475,4,"Business",0.5 }, 	-- Maze Bank Filial
	{ -1581.1868896484,-558.27209472656,34.948238372803,475,4,"Business",0.5 }, 	-- Lom Bank
	{ 299.64303588867,-759.25268554688,29.338165283203,475,4,"Business",0.5 }, 	-- Escritório básico
	{ -1007.1130981445,-486.66296386719,39.965377807617,475,4,"Business",0.5 }, 	-- Escritório médio
	{ -1913.4766845703,-574.10241699219,11.430200576782,475,4,"Business",0.5 }, 	-- Escritório de luxo
	{ -22.449825286865,-192.71127319336,52.359741210938,475,4,"Business",0.5 }, 	-- Hawick Clubhouse
}
