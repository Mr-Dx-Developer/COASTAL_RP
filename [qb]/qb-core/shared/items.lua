...
QBShared.Items = {
    ...
    weapon_lok                   = { name = 'weapon_lok',       label = 'PD M-LOK AR 15',      weight = 5500, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'WEAPON_LOK.png', unique = true, useable = false, description = 'M-LOK AR 15' },
    ...
    weapon_glock19x              = { name = 'weapon_glock19x',  label = 'PD G19X XL',          weight = 2000, type = 'weapon', ammotype = 'AMMO_PISTOL', image = 'WEAPON_GLOCK19X.png', unique = true, useable = false, description = 'G19X XL' },
    ...
    weapon_glock40s              = { name = 'weapon_glock40s',  label = 'PD GLOCK 40 SWITCH',  weight = 2000, type = 'weapon', ammotype = 'AMMO_PISTOL', image = 'WEAPON_GLOCK40S.png', unique = true, useable = false, description = 'G40 SWITCH' },
    ...
    weapon_pitviper              = { name = 'weapon_pitviper',  label = 'PD JW4 PIT VIPER',    weight = 2000, type = 'weapon', ammotype = 'AMMO_PISTOL', image = 'WEAPON_PITVIPER.png', unique = true, useable = false, description = 'JW4 PIT VIPER' },
    ...
    weapon_glock18c              = { name = 'weapon_glock18c',  label = 'PD GLOCK 18C',        weight = 2000, type = 'weapon', ammotype = 'AMMO_PISTOL', image = 'WEAPON_GLOCK18C.png', unique = true, useable = false, description = 'GLOCK 18C' },
    ...
    weapon_m32s                  = { name = 'weapon_m32s',      label = 'PD M32 SMOKE GL',     weight = 6000, type = 'weapon', ammotype = 'AMMO_GRENADELAUNCHER', image = 'WEAPON_M32S.png', unique = true, useable = false, description = 'A BOOM' },
    ...
    weapon_nightstick            = { name = 'weapon_nightstick', label = 'Night Stick', weight = 1000, type = 'weapon', ammotype = nil, image = 'weapon_nightstick.png', unique = true, useable = false, description = 'A police officer\'s club or billy' },
    ...
    weapon_revolver              = { name = 'weapon_revolver', label = 'CRP Pistol', weight = 1000, type = 'weapon', ammotype = 'AMMO_PISTOL', image = 'weapon_revolver.png', unique = true, useable = false, description = 'A pistol with revolving chambers enabling several shots to be fired without reloading' },
    ...
    weapon_smg                   = { name = 'weapon_smg', label = 'PD SMG', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'weapon_smg.png', unique = true, useable = false, description = 'A handheld light                                                                                                                                                                                                                                                                                                                                                                 weight machine gun' },
    ...
    weapon_pumpshotgun_mk2       = { name = 'weapon_pumpshotgun_mk2', label = 'PD Pump Shotgun MK2', weight = 1000, type = 'weapon', ammotype = 'AMMO_SHOTGUN', image = 'weapon_pumpshotgun_mk2.png', unique = true, useable = true, description = 'Pumpshotgun MK2' },
    weapon_combatshotgun         = { name = 'weapon_combatshotgun', label = 'PD Combat Shotgun', weight = 1000, type = 'weapon', ammotype = 'AMMO_SHOTGUN', image = 'weapon_combatshotgun.png', unique = true, useable = true, description = 'Weapon Combatshotgun' },
    ...
    weapon_carbinerifle_mk2      = { name = 'weapon_carbinerifle_mk2', label = 'PD Carbine Rifle Mk II', weight = 1000, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'weapon_carbinerifle_mk2.png', unique = true, useable = true, description = 'Carbine Rifle MK2' },
    ...
    -- Ammo ITEMS
    pistol_ammo                  = { name = 'pistol_ammo', label = 'Pistol ammo', weight = 100, type = 'item', image = 'pistol_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Pistols' },
    rifle_ammo                   = { name = 'rifle_ammo', label = 'Rifle ammo', weight = 100, type = 'item', image = 'rifle_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Rifles' },
    smg_ammo                     = { name = 'smg_ammo', label = 'SMG ammo', weight = 100, type = 'item', image = 'smg_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Sub Machine Guns' },
    shotgun_ammo                 = { name = 'shotgun_ammo', label = 'Shotgun ammo', weight = 100, type = 'item', image = 'shotgun_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Shotguns' },
    mg_ammo                      = { name = 'mg_ammo', label = 'MG ammo', weight = 200, type = 'item', image = 'mg_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Machine Guns' },
    ...
    ammo_grenadelauncher                  = { name = 'ammo_grenadelauncher', label = 'Grenade Launcher ammo', weight = 200, type = 'item', image = 'grenadelauncher_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo' },
    ...
    ifaks                        = { name = 'ifaks', label = 'ifaks', weight = 10, type = 'item', image = 'ifaks.png', unique = false, useable = true, shouldClose = true, description = 'ifaks for healing and a complete stress remover.' },
    ...
    radio                        = { name = 'radio', label = 'Radio', weight = 200, type = 'item', image = 'radio.png', unique = true, useable = true, shouldClose = true, description = 'You can communicate with this through a signal' },
    iphone                       = { name = 'iphone', label = 'Gang Phone', weight = 1000, type = 'item', image = 'iphone.png', unique = false, useable = true, shouldClose = true, description = 'System Encrypted' },
    samsungphone                 = { name = 'samsungphone', label = 'Samsung S10', weight = 1000, type = 'item', image = 'samsungphone.png', unique = false, useable = true, shouldClose = true, description = 'Very expensive phone' },
...
['vape']              			 = {['name'] = 'vape',               		    ['label'] = 'Vape',                    ['weight'] = 10,         ['type'] = 'item',         ['image'] = 'vape.png',         ['unique'] = false,         ['useable'] = true,     ['shouldClose'] = true,       ['combinable'] = nil,   ['description'] = 'Blow clouds', ["created"] = nil, ["decay"] = 2.0},
['vapejuice']              			 = {['name'] = 'vapejuice',               		    ['label'] = 'Vape Juice',                    ['weight'] = 10,         ['type'] = 'item',         ['image'] = 'vapejuice.png',         ['unique'] = false,         ['useable'] = true,     ['shouldClose'] = true,       ['combinable'] = nil,   ['description'] = 'Blow clouds', ["created"] = nil, ["decay"] = 2.0},
...
['ifaks']                        = {['name'] = 'ifaks',                         ['label'] = 'ifaks',                    ['weight'] = 30,      ['type'] = 'item',       ['image'] = 'ifaks.png',                ['unique'] = false,     ['useable'] = true,     ['shouldClose'] = true,    ['combinable'] = nil,   ['description'] = 'ifaks for healing and a complete stress remover.'},
