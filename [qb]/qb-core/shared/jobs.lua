...
QBShared.Jobs = {
	...
	police = {
		...
		grades = {
			...
			['3'] = { name = 'Sergeant', payment = 125 },
			['4'] = { name = 'Master Sergeant', payment = 50 },
			['5'] = { name = 'Lieutenant', payment = 75 },
			['6'] = { name = 'Captain', payment = 100 },
			['7'] = { name = 'Commander', payment = 125 },
			['8'] = { name = 'Colonel', payment = 50 },
			['9'] = { name = 'Assistant Chief', isboss = true, payment = 75 },
			['10'] = { name = 'Chief', isboss = true, payment = 100 },
