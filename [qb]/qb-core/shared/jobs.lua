...
QBShared.Jobs = {
	...
	ambulance = {
		...
		offDutyPay = false,
		grades = {
			['0'] = { name = 'EMT', payment = 3600 },
			['1'] = { name = 'EMT Advance', payment = 3700 },
			['2'] = { name = 'Sergeant', payment = 3800 },
			['3'] = { name = 'Lead-Paramedic', payment = 3900 },
			['4'] = { name = 'Specialist', payment = 4000 },
			['5'] = { name = 'Lieutenant', payment = 4100 },
			['6'] = { name = 'Captain', payment = 4200 },
			['7'] = { name = 'Assistant Chief', isboss = true, payment = 4300 },
