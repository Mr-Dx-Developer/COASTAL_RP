	...
	['alcohol_market'] = {
		...
		['items'] = {
			['beer'] = {						-- The item ID
				...
				['price_to_customer'] = 70,		-- Price the customer will pay when buy the product in store
				['price_to_customer_min'] = 30,	-- Min price that the owner will be able to set on this product
				['price_to_customer_max'] = 140,	-- Max price that the owner will be able to set on this product
				['price_to_export'] = 60,		-- Price the owner will receive when exporting the item
				['price_to_owner'] = 50,			-- Price the store owner must pay when importing goods to your store
				['amount_to_owner'] = 350,		-- Amount of goods the owner will get when importing to store (This value can be increased if he upgraded his truck capacity)
				['amount_to_delivery'] = 350,	-- Max amount of goods the owner can set when creating a job to deliveryman
	...
	['pistol_weapons'] = {
		...
		['items'] = {
			['weapon_pistol50'] = {
				...
				['price_to_customer_min'] = 3750,
				['price_to_customer_max'] = 6000,
				['price_to_export'] = 3350,
				['price_to_owner'] = 3200,
				['amount_to_owner'] = 10,
