                ...
                if usingAdvanced then
                    ...
                    if success then
                        ...
                        if math.random(1, 100) <= Config.ChanceToBreakAdvancedLockPick then
                            ...
                            TriggerEvent('codem-inventory:client:ItemBox', QBCore.Shared.Items['advancedlockpick'], 'remove')
                        end
                    ...
                    if success then
                        ...
                        if math.random(1, 100) <= Config.ChanceToBreakLockPick then
                            ...
                            TriggerEvent('codem-inventory:client:ItemBox', QBCore.Shared.Items['lockpick'], 'remove')
                        end
                        QBCore.Functions.Notify(Lang:t('error.didnt_work'), 'error', 2500)
                    end
                end
    ...
    while true do
                    ...
                    if CurrentCops >= Config.PoliceOnDutyRequired then
                        if Config.Houses[k]['opened'] then
                            ...
                            if not requiredItemsShowed then
                                ...
                                TriggerEvent('codem-inventory:client:requiredItems', requiredItems, true)
                            end
                        end
                    end
                end
        ...
        if not inRange then
            if requiredItemsShowed then
                ...
                TriggerEvent('codem-inventory:client:requiredItems', requiredItems, false)
            end
            Wait(1000)
        end
        Wait(1)
