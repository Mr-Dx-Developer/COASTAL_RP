...
Main.InventoryName = "qb-inventory" -- Your inventory resource name
...
Main.LegacyFuelName = 'LegacyFuel' -- This is your LegacyFuel name (can be ps-fuel or lj-fuel or whatever other fuel system that use the same events as LegacyFuel)
...
Main.ImagesDirectory = 'nui://qb-inventory/html/images/' -- The directory to inventory images folder