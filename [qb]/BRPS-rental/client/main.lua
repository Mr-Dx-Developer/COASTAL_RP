...
RegisterNUICallback('rent', function(data)
    ...
    TriggerServerEvent("BRPS-rental:sv:rentVehicle", data)
end)

RegisterNetEvent('BRPS-rental:cl:spawnVehicle', function(model,time)
    QBCore.Functions.SpawnVehicle(model, function(vehicle)
        ...
        TriggerServerEvent("BRPS-rental:sv:updatesql", plate, model, time)
    end, spawncarcoords, true)
end)

CreateThread(function()
    while true do
        TriggerServerEvent("BRPS-rental:sv:checktime")
        Wait(3600000)
    end
end)
