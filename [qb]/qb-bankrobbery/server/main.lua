        ...
        if WeaponChance ~= odd1 then
            if tier ~= 4 then
                if Config.RewardTypes[itemType].type == 'item' then
                    ...
                    TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items[item.item], 'add')
                elseif Config.RewardTypes[itemType].type == 'money' then
                    ...
                    TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items['markedbills'], 'add')
                end
            else
                exports['codem-inventory']:AddItem(src, 'security_card_01', 1, false, false, 'qb-bankrobbery:server:recieveItem')
                TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items['security_card_01'], 'add')
            end
        else
            exports['codem-inventory']:AddItem(src, 'weapon_stungun', 1, false, false, 'qb-bankrobbery:server:recieveItem')
            TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items['weapon_stungun'], 'add')
        end
    elseif type == 'paleto' then
        ...
        if WeaponChance ~= odd1 then
            if tier ~= 4 then
                ...
                TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items['security_card_02'], 'add')
            end
        else
            exports['codem-inventory']:AddItem(src, 'weapon_vintagepistol', 1, false, false, 'qb-bankrobbery:server:recieveItem')
            TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items['weapon_vintagepistol'], 'add')
        end
    elseif type == 'pacific' then
        ...
        if WeaponChance ~= odd1 or WeaponChance ~= odd2 then
            if tier ~= 4 then
                ...
                TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items['cryptostick'], 'add')
            end
        else
            ...
            if chance == odd then
                ...
                TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items['weapon_microsmg'], 'add')
            else
                exports['codem-inventory']:AddItem(src, 'weapon_minismg', 1, false, false, 'qb-bankrobbery:server:recieveItem')
                TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items['weapon_minismg'], 'add')
            end
        end
    end
end)
...
RegisterNetEvent('qb-bankrobbery:server:removeElectronicKit', function()
    ...
    TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items['electronickit'], 'remove')
    exports['codem-inventory']:RemoveItem(src, 'trojan_usb', 1, false, 'qb-bankrobbery:server:removeElectronicKit')
    TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items['trojan_usb'], 'remove')
end)
...
RegisterNetEvent('qb-bankrobbery:server:removeBankCard', function(number)
    ...
    TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items['security_card_' .. number], 'remove')
end)
...
QBCore.Functions.CreateCallback('thermite:server:check', function(source, cb)
    ...
    if exports['codem-inventory']:RemoveItem(source, 'thermite', 1, false, 'thermite:server:check') then
        TriggerClientEvent('codem-inventory:client:ItemBox', source, QBCore.Shared.Items['thermite'], 'remove')
        cb(true)
    else
        cb(false)
    end
