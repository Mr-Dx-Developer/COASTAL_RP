...
Config.Stores = {
    [1] = {shopType = 'clothing', coords = vector3(1693.32, 4823.48, 41.06), width = 4, length = 4},
    [2] = {shopType = 'clothing', coords = vector3(-712.215881, -155.352982, 37.4151268), width = 4, length = 4},
    [3] = {shopType = 'clothing', coords = vector3(-1192.94495, -772.688965, 17.3255997), width = 4, length = 4},
    [4] = {shopType = 'clothing', coords = vector3(425.236, -806.008, 28.491), width = 4, length = 4},
    [5] = {shopType = 'clothing', coords = vector3(-162.658, -303.397, 38.733), width = 4, length = 4},
    [6] = {shopType = 'clothing', coords = vector3(75.950, -1392.891, 28.376), width = 4, length = 4},
    [7] = {shopType = 'clothing', coords = vector3(-822.194, -1074.134, 10.328), width = 4, length = 4},
    [8] = {shopType = 'clothing', coords = vector3(-1450.711, -236.83, 48.809), width = 4, length = 4},
    [9] = {shopType = 'clothing', coords = vector3(4.254, 6512.813, 30.877), width = 4, length = 4},
    [10] = {shopType = 'clothing', coords = vector3(615.180, 2762.933, 41.088), width = 4, length = 4},
    [11] = {shopType = 'clothing', coords = vector3(1196.785, 2709.558, 37.222), width = 4, length = 4},
    [12] = {shopType = 'clothing', coords = vector3(-3171.453, 1043.857, 19.863), width = 4, length = 4},
    [13] = {shopType = 'clothing', coords = vector3(-1100.959, 2710.211, 18.107), width = 4, length = 4},
    [14] = {shopType = 'clothing', coords = vector3(-1207.65, -1456.88, 4.3784737586975), width = 4, length = 4},
    [15] = {shopType = 'clothing', coords = vector3(121.76, -224.6, 53.56), width = 4, length = 4},
    [16] = {shopType = 'barber', coords = vector3(-814.3, -183.8, 36.6), width = 4, length = 4},
    [17] = {shopType = 'barber', coords = vector3(136.8, -1708.4, 28.3), width = 4, length = 4},
    [18] = {shopType = 'barber', coords = vector3(-1282.6, -1116.8, 6.0), width = 4, length = 4},
    [19] = {shopType = 'barber', coords = vector3(1931.5, 3729.7, 31.8), width = 4, length = 4},
    [20] = {shopType = 'barber', coords = vector3(1212.8, -472.9, 65.2), width = 4, length = 4},
    [21] = {shopType = 'barber', coords = vector3(-32.9, -152.3, 56.1), width = 4, length = 4},
    [22] = {shopType = 'barber', coords = vector3(-278.1, 6228.5, 30.7), width = 4, length = 4}
}
...
Config.OutfitChangers = {
  ...
  --  [3] = {shopType = 'outfit', coords = vector3(-1187.19, -768.64, 16.33), width = 2, length = 2},
    [1] = {shopType = 'outfit', coords = vector3(429.668, -810.53, 29.491), width = 2, length = 2},
  ...
  --  [8] = {shopType = 'outfit', coords = vector3(-1447.51, -242.81, 48.82), width = 2, length = 2},
   ...
   -- [13] = {shopType = 'outfit', coords = vector3(-1108.95, 2709.37, 18.11), width = 2, length = 2},
    [2] = {shopType = 'outfit', coords = vector3(-1203.79, -1454.53, 3.38), width = 2, length = 2},
    [3] = {shopType = 'outfit', coords = vector3(117.95, -233.418, 54.558), width = 2, length = 2},
    [4] = {shopType = 'outfit', coords = vector3(-703.83, -151.67, 36.42), width = 2, length = 2},
}

-- set isGang to true if the requiredJob is a gang
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(460.357, -998.885, 30.69), width = 2, length = 2, cameraLocation = vector4(460.357, -998.885, 30.69, 277.578)},
    [2] = {requiredJob = 'ambulance', isGang = false, coords = vector4(-443.688, -311.883, 34.911, 297.076), width = 2, length = 2, cameraLocation = vector4(-443.688, -311.883, 34.911, 297.076)}
