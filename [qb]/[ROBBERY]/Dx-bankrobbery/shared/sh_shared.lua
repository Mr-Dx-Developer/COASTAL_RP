...
Shared.Banks = {
    ['PinkCage'] = {
        ...
        trolly = {
            [1] = { type = 'cash', busy = false, taken = false, coords = vector4(313.47702, -289.2542, 54.1431, 320.27249) },
            [2] = { type = 'cash', busy = false, taken = false, coords = vector4(311.61235, -287.6962, 54.143051, 305.18524) }
        }
    },
    ['Legion'] = {
        label = 'Legion Square',
        ...
        trolly = {
            [1] = { type = 'cash', busy = false, taken = false, coords = vector4(147.13935, -1049.607, 29.34633, 311.47201) },
            [2] = { type = 'cash', busy = false, taken = false, coords = vector4(149.51391, -1050.767, 29.346384, 291.46362) }
        }
    },
    ['Hawick'] = {
        label = 'Hawick Ave',
        ...
        trolly = {
            [1] = { type = 'cash', busy = false, taken = false, coords = vector4(-353.644, -59.04, 49.0148, 309.626) },
            [2] = { type = 'cash', busy = false, taken = false, coords = vector4(-351.6271, -59.91, 49.0148, 296.23211) }
        }
    },
    ['DelPerro'] = {
        ...
        trolly = {
            [1] = { type = 'cash', busy = false, taken = false, coords = vector4(-1207.97, -338.9731, 37.759284, 353.9089) },
            [2] = { type = 'cash', busy = false, taken = false, coords = vector4(-1205.895, -338.0665, 37.759326, 340.50067) }
        }
    },
    ['GreatOcean'] = {
        ...
        trolly = {
            [1] = { type = 'cash', busy = false, taken = false, coords = vector4(-2953.083, 482.7803, 15.675336, 49.137405) },
            [2] = { type = 'cash', busy = false, taken = false, coords = vector4(-2952.881, 485.22781, 15.675389, 37.428142) }
        }
    },
    ['Sandy'] = {
        label = 'Sandy Shores',
        ...
        trolly = {
            [1] = { type = 'cash', busy = false, taken = false, coords = vector4(1174.6406, 2716.2036, 38.066295, 141.10868) },
            [2] = { type = 'cash', busy = false, taken = false, coords = vector4(1171.6578, 2716.2761, 38.066303, 231.91242) }
        }
    },
    ['Maze'] = {
        label = 'Maze Bank',
        ...
        trolly = {
            [1] = { type = 'cash', taken = false, coords = vector4(-1310.97, -811.23, 17.15, 221.28) },
    ...
    ['Paleto'] = {
        ...
        trolly = {
            [1] = { type = 'cash', taken = false, coords = vector4(-106.2033, 6477.7485, 31.626792, 175.3149) },
            [2] = { type = 'cash', taken = false, coords = vector4(-104.9971, 6478.7548, 31.649032, 257.95233) }
        },
        thermite = {
    ...
    ['Pacific'] = {
        ...
        trolly = {
            ...
            [3] = { type = 'cash', taken = false, coords = vector4(262.24, 213.16, 101.68, 31.58) },
            [4] = { type = 'cash', taken = false, coords = vector4(259.32, 214.94, 101.68, 114.46) }
        },
        thermite = {
            [1] = {
    ...
    ['Vault'] = {
        ...
        stacks = {
            [1] = { type = 'cash', busy = false, taken = false, coords = vector4(265.812, 241.233, 101.581, 250.0) },
            [2] = { type = 'cash', busy = false, taken = false, coords = vector4(268.112, 247.533, 101.581, 250.0) },
            [3] = { type = 'cash', busy = false, taken = false, coords = vector4(254.062, 258.454, 101.581, 70.0) },
        ...
        trolly = {
            ...
            [3] = { type = 'cash', taken = false, coords = vector4(266.05, 258.54, 101.68, 70.56) },
            [4] = { type = 'cash', taken = false, coords = vector4(261.49, 260.25, 101.68, 287.52) }
        },
        explosion = {
