...
RegisterNetEvent("BRPS-hud:Client:HandleCallback", function(key, data)
...
RegisterNetEvent("BRPS-hud:Client:OpenHudSettings", function()
    SetNuiFocus(true, true)
    Koci.Client:SendReactMessage("setRouter", "settings")
end)
RegisterNetEvent("BRPS-hud:Client:SetManualGear", function(newGear)
...
elseif GetResourceState("saltychat") == "started" then
    ...
    TriggerServerEvent("BRPS-hud:Server:ErrorHandle", "Setup your custom voice resource at: client/utils.lua")
