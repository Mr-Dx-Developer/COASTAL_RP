...
RegisterServerEvent('qb-crafting:server:removeMaterials', function(itemName, amount)
    ...
    if Player then
        ...
        TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items[itemName], 'remove')
    end
end)
...
RegisterNetEvent('qb-crafting:server:removeCraftingTable', function(benchType)
    ...
    TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items[benchType], 'remove')
...
RegisterNetEvent('qb-crafting:server:addCraftingTable', function(benchType)
    ...
    TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items[benchType], 'add')
end)
...
RegisterNetEvent('qb-crafting:server:receiveItem', function(craftedItem, requiredItems, amountToCraft, xpGain, xpType)
    ...
    for _, requiredItem in ipairs(requiredItems) do
        ...
        TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items[requiredItem.item], 'remove')
    end
    if canGive then
        ...
        TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items[craftedItem], 'add')
