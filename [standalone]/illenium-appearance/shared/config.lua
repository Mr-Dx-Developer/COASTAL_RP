...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(480.683, -1010.238, 30.689, 292.072),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(473.006, -1016.118, 30.689),
            vector3(473.023, -1006.906, 30.689),
            vector3(483.357, -1007.548, 30.689),
            vector3(483.36, -1014.975, 30.689)
        }
    }
}
