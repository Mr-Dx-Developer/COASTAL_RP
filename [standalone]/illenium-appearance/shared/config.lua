...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(443.17, -994.039, 35.062, 359.544),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(444.206, -997.698, 35.062),
            vector3(444.941, -990.519, 35.585),
            vector3(438.873, -990.536, 35.062),
            vector3(439.042, -997.209, 35.062)
        }
    }
}
