...
CONFIG.Option = {                                           -- Option
    Update = {                                              -- Update
        Time = 2                                           -- เวลาในการอัพเดทสถานะ (ระบุเป็น “วินาที”) | Discord_UpdatePresence() มีขีดจำกัดอยู่ที่ 1 ครั้งต่อ 15 วินาที
    },
...
CONFIG.Discord = {                                          -- Discord
    Application = {                                         -- Application (Developer Portal: https://discord.com/developers/applications)
        ID = 1247458877193191446                            -- ID (รูปภาพตัวอย่าง: https://i.imgur.com/cWZjHB3.png)
    },
    ...
    Asset = {                                               -- Asset (Art Assets: https://discord.com/developers/applications/YOUR_APP_ID/rich-presence/assets)
        Logo = {                                            -- ภาพสัญลักษณ์ (ขนาดปกติ)
            Name = 'brp',                            -- ชื่อ (รูปภาพตัวอย่าง: https://imgur.com/y1Amkyu.png)
            Text = 'BRPS'                    -- ข้อความ
        },

        Icon = {                                            -- ภาพสัญลักษณ์ (ขนาดเล็ก)
            Name = 'brp',                            -- ชื่อ (รูปภาพตัวอย่าง: https://i.imgur.com/0STQ7rh.png)
            Text = 'BRPS'                    -- ข้อความ
        }
    },
    ...
    Button = {                                              -- Button (ปุ่ม)
        [1] = {                                             -- ปุ่มที่ 1
            ...
            URL = 'https://discord.gg/e3yTCdWU4q'               -- URL
        },

        [2] = {                                             -- ปุ่มที่ 2
            Text = 'Join Server',                           -- ข้อความ
            URL = 'fivem://connect/cfx.re/join/v79dkk'         -- URL
        }
    }
}
