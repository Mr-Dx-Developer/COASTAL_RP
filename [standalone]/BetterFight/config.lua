...
Config.Weapons= {
    ...
    [6] = { hash = `WEAPON_PISTOL50`, recoil = 0.10, rightLeftRecoil = 3.90, vehicleRecoil = 2.90, vehicleRightLeftRecoil = 2.50, gripMultiplier = 0.00, suppressorMultiplier = 0.00, damageMultiplier = 0.50},
    ...
    [13] = { hash = `WEAPON_REVOLVER`, recoil = 0.10, rightLeftRecoil = 1.00, vehicleRecoil = 3.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.00, suppressorMultiplier = 0.00, damageMultiplier = 1.5},
