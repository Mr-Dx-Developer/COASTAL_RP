...
Config.custom_scripts_compatibility = {
	...
	['inventory'] = "other",					-- [ox_inventory|qs-inventory|ps-inventory|default|other] Inventory script Compatibility
	['keys'] = "default",						-- [qs-vehiclekeys|cd_garage|jaksam|wasabi_carlock|default|other] Keys script Compatibility
	['mdt'] = "ps-md",						-- [ps-mdt|default|other] MDT script Compatibility (to log weapon serial)
